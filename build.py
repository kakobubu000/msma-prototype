...
<style>
  ...
  *{box-sizing:border-box; margin:0; padding:0;}
  ...
  .share{border:1px solid var(--line); border-radius:12px; padding:18px 20px; margin-top:26px; background:var(--bg);}
...
<div class="wrap">
  ...
  <div id="screen-start" class="card">
    <p style="color:var(--muted); font-size:15px;">The purpose of the MSMA is to translate a mentee&rsquo;s identified needs into the specific mentoring skills that can become the focus of the mentoring relationship. This assessment is completed by the mentor after the Mentee Top Needs Assessment.</p>
  ...
  <div id="screen-entry" class="card hidden">
    ...
    <p class="note" style="margin-top:6px;">The mentor will input the needs from each respondent after completion of the Top Needs Assessment.</p>
    <div class="two">
      <div>
        <label class="lbl" for="f-role">Mentor</label>
        <input class="field" id="f-role" placeholder="Your name or mentor ID">
      </div>
      <div>
    ...
    <p class="note">Use the student's assigned ID or case code rather than their name.</p>
    <div class="needs">
